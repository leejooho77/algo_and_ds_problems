 ...
 * @since Dec 15, 2019
 */
public class problem_0215 {

    public int myAtoi(String str) {
        // trim all front whitespace
        str = str.trim();
        ...
        int rangeCheck;
        /***********************************************************/
        // first char isn't digit or sign, return 0
        if(str.charAt(0) == '+' || str.charAt(0) == '-') {
            sign = (str.charAt(0) == '+') ? sign : sign * -1;
            str = str.substring(1);
        }
        // check if string is empty or if first char isn't digit
        ...
        for(int i = 0; i < str.length(); i++) {
            ...
            // check if result is in range of min_integer to max_integer
            if(result / 10 != rangeCheck) return (sign > 0) ? Integer.MAX_VALUE : Integer.MIN_VALUE;
        }
        return sign * result;
    }
